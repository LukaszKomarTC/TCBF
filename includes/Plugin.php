...
/**
	...
	public function output_form_field_css() : void {
		...
		if ( $is_cart ) {
			...
			echo "  }\n";
			echo "\n";
			echo "  /* Parent row: pad away from border (mobile + tablet) */\n";
			...
			echo "  }\n";
			echo "\n";
			echo "  /* Child row: indented padding on mobile + tablet */\n";
			echo "  tr.tcbf-cart-row--child > td:not(.product-remove) {\n";
			echo "    padding-left: 20px !important;\n";
			echo "  }\n";
			echo "\n";
			echo "  /* Suppress ::before pseudo-elements on special rows (service card, separator, footer) */\n";
			...
			echo "  }\n";
			echo "\n";
			echo "  /* Suppress ::before on thumbnail/remove cells for all cart rows (prevents stray labels) */\n";
			...
			echo "  }\n";
			echo "\n";
			echo "  /* Suppress ::before on product-name cell (product title is self-evident) */\n";
